...
import org.ieee.odm.adapter.psse.parser.dynamic.exciter.PSSEExcIEEE1981DC1Parser;
...
public class PSSEExcIEEE1981DC1Mapper extends BasePSSEDataMapper{
	...
	public void procLineString(String lineStr, DStabModelParser parser) throws ODMException {
	    ...
	    //check model type
	    if(!dataParser.getString("Type").equals("IEEEX1")){
