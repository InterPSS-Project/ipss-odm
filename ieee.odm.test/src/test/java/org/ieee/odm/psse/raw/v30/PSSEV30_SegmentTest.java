...
public class PSSEV30_SegmentTest { 
    ...
    // <z unit="PU" re="2.7727777777777777E-4" im="0.021131514257424346"/>
    ...
    /*
     *  <z23 unit="PU" re="0.0011840706447187929" im="0.05730258261164876"/>
        <z31 unit="PU" re="0.0011357596021947874" im="0.08235327967714953"/>
     */
		assertTrue(Math.abs(branch.getZ23().getRe()- 0.0011840706447187929)<1.0E-6);
    assertTrue(Math.abs(branch.getZ23().getIm()- 0.05730258261164876)<1.0E-6);
		assertTrue(Math.abs(branch.getZ31().getRe()-0.0011357596021947874)<1.0E-6);
		assertTrue(Math.abs(branch.getZ31().getIm()-0.08235327967714953)<1.0E-6);
