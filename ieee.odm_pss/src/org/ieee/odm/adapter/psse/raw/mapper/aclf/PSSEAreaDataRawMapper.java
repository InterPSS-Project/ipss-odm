...
import org.ieee.odm.adapter.psse.raw.parser.aclf.PSSEAreaDataRawParser;
...
public class PSSEAreaDataRawMapper extends BasePSSEDataRawMapper{
	
	public PSSEAreaDataRawMapper(PsseVersion ver) {
		super(ver);
		this.dataParser = new PSSEAreaDataRawParser(ver);
	}
