...
import org.ieee.odm.adapter.psse.raw.parser.dynamic.relay.PSSERelayLDS3DataParser;
...
public class PSSERelayLDS3Mapper extends BasePSSEDataRawMapper{
	...
	public void procLineString(String lineStr, DStabModelParser parser) throws ODMException {
	    ...
	    //check model type
	    if(!dataParser.getValue("Type").equals("LDS3BL")){
	   ...
	   if(busXml!=null){ 
	        ...
	        if(lds3!= null){
    			...
    			String GID   = dataParser.getValue("GID");
