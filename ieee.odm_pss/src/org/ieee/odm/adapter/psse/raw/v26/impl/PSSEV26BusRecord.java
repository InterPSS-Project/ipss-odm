...
public class PSSEV26BusRecord {
	private PSSEBusDataRawParser busDataParser = null;
	private PSSEGenDataRawParser genDataParser = null;
	private PSSELoadDataRawParser loadDataParser = null;
	
	public PSSEV26BusRecord(PsseVersion version) {
		this.busDataParser = new PSSEBusDataRawParser(version);
		this.genDataParser = new PSSEGenDataRawParser(version);
		this.loadDataParser = new PSSELoadDataRawParser(version);
	}
