 ...
 *
 */
package org.ieee.odm.adapter.psse.raw.v26.impl;
...
public class PSSEV26NetRecord {
	...
	PSSEHeaderDataRawParser headerDataParser = new PSSEHeaderDataRawParser(PsseVersion.PSSE_26);
	PSSEAreaInterchangeDataRawParser areaInterDataParser = new PSSEAreaInterchangeDataRawParser(PsseVersion.PSSE_26);
	PSSEInterAreaTransferRawDataParser interAreaDataParser = new PSSEInterAreaTransferRawDataParser(PsseVersion.PSSE_26);
