...
import org.ieee.odm.adapter.psse.raw.parser.aclf.PSSEDcLine2TDataRawParser;
...
public class PSSEDcLine2TDataRawMapper extends BasePSSEDataRawMapper{
	
	public PSSEDcLine2TDataRawMapper(PsseVersion ver) {
		super(ver);
		this.dataParser = new PSSEDcLine2TDataRawParser(ver);
	}
