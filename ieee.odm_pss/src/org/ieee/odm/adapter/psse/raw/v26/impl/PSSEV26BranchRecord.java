...
import org.ieee.odm.adapter.psse.raw.parser.aclf.PSSEXfrAdjustDataRawParser;
...
public class PSSEV26BranchRecord {
	PSSELineDataRawParser branchDataParser = new PSSELineDataRawParser(PsseVersion.PSSE_26);
	PSSEXfrAdjustDataRawParser xfrAdjDataParser = new PSSEXfrAdjustDataRawParser(PsseVersion.PSSE_26);
